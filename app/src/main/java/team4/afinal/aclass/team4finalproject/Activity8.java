...
public class Activity8 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGoMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Activity8.this, Activity3.class);
                startActivity(i);
    ...
    private void upload() {
        ...
        Toast.makeText(Activity8.this, "서버로 메모 글쓰기 성공!!",Toast.LENGTH_SHORT).show();
