...
public class Activity7Modify extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_7modify);
        ...
        intent = getIntent();
        bean = (GiverBean) intent.getSerializableExtra("modifydata");

        edtCareer.setText(bean.career);
        ...
        btnModify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                upload();
                Intent i = new Intent(Activity7Modify.this, Activity4_tabMain.class);
                startActivity(i);
                finish();
        ...
        btnGoMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Activity7Modify.this, Activity3.class);
                startActivity(i);
    ...
    private void upload() {
        ...
        Toast.makeText(Activity7Modify.this, "성공적으로 수정되었습니다!",Toast.LENGTH_SHORT).show();
